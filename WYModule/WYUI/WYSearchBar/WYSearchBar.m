...
//16进制颜色
#define WY_SBAR_COLOR_HEX(rgbValue) \
...
{
    WYSearchBarIconAlign _iconAlignTemp;
...
- (void)setIconAlign:(WYSearchBarIconAlign)iconAlign
{
    if(!_iconAlignTemp)
    {
...
- (void)ajustIconWith:(WYSearchBarIconAlign)iconAlign
{
...
{
    if(_iconAlignTemp == WYSearchBarIconAlignCenter)
    {
